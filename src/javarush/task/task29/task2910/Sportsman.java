...
import static javarush.task.task29.task2910.Constants.*;
...
public class Sportsman {
    ...
    public Sportsman(int number) {
        ...
        chanceToHit = BigDecimal.valueOf(ThreadLocalRandom.current().
                // Возвращает псевдослучайное двойное значение
                // между указанным источником (включительно) и связанным (исключение).
                nextDouble(MIN_CHANCE_TO_HIT_IN_TARGET.doubleValue(),
