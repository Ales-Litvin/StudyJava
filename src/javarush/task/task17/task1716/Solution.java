package javarush.task.task17.task1716;
...
public class Solution {
    ...
    synchronized double method3() {  // ТУТ
        double random = Math.random();
        param += 40.7;
        return random + param;
    }

    synchronized private void method4() {  // ТУТ
    ...
    public synchronized String method6(int param2) { // тут
