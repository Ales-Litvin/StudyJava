package javarush.task.task24.task2412;
...
public class Solution {
    ...
    public static void printStocks(List<Stock> stocks, Date actualDate) {
        ...
        for (Stock stock : stocks) {
            ...
            // testArgs - это массив аргументов для передачи в pattform тип MessageFormat
            // Ошибка найдена в строке 45 неправильный массив testFormats
        }
    }

    /*
     * Здесь написать компоратор для Stock:
     * 1.1. Первичная сортировка по name в алфавитном порядке
    ...
    public static void sort(List<Stock> list) {
        list.sort(new Comparator<Stock>() {
            // compare возращает числове значение если оно:
            // отрицательное то объект stock1 предшествует объекту stock2
            // пооложительное то наоборот
            // равно "0" то объекты равны
            ...
            @Override
            public int compare(Stock stock1, Stock stock2) {
                Double profit1 = (Double) stock1.get("change");
                Double profit2 = (Double) stock2.get("change");

                if (profit1 == null)
                    profit1 = (Double) (((double) stock1.get("last")) - ((double) stock1.get("open")));

                if (profit2 == null)
                    profit2 = (Double) (((double) stock2.get("last")) - ((double) stock2.get("open")));
