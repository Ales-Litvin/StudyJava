    ...
    public Sayable toSayable(final int i) {
        ...
        class CatPet implements Sayable{
            ...
            public String say() {
                ...
                if (i < 1){
                    stringBuilder = stringBuilder.append(name + " спит.");
                }
                if (i >= 1){
                    stringBuilder = stringBuilder.append(name + " говорит м");

                    for (int j = i; j >= 1; j--) {
                        stringBuilder = stringBuilder.append("я");
                    }

                    stringBuilder = stringBuilder.append("y!");
                }
