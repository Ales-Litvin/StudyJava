package javarush.task.task24.task2408;
        ...
        class DogPet extends SuperDog implements Sayable {
            ...
            public String say() {
                ...
                if (i >= 1){
                    ...
                    stringBuilder = stringBuilder.append(getName() + " лает г");

                    for (int j = i; j >= 1; j--) {
                        stringBuilder = stringBuilder.append("а");
                    }

                    stringBuilder = stringBuilder.append("в! ");

                    stringBuilder = stringBuilder.append(formatter.format(new Date()).toString());
