...
/*
 * Наш непойманых исключений укратитель
 */
...
public class OurUncaughtExceptionHandler implements Thread.UncaughtExceptionHandler {
    ...
    /*
     * Реализуйте логику трех protected методов в OurUncaughtExceptionHandler используя
     * вызовы соответствующих методов согласно следующим шаблонам:
