...
public class Main {
     ...
     * 1. In the tunnel all ships arrived for unloading, then it will work infinity, because
     *    the port will crowded.
     *
     * 2. In the tunnel all ships arrived for loading, then it will work infinity, because
     *    in the port not 'containers'.
     *
