...
public class Solution {
    public static void main(String[] args) {
        ...
        airport.add(new Airline("Berlin",
                ...
                AircraftType.A220,
                new Time(6, 45,0),
                new DayOfWeek[]{DayOfWeek.FRIDAY, DayOfWeek.MONDAY, DayOfWeek.SATURDAY}
        ));
        ...
        airport.add(new Airline("Moscow",
                ...
                AircraftType.A220,
                new Time(4, 30,0),
                new DayOfWeek[]{DayOfWeek.FRIDAY, DayOfWeek.WEDNESDAY, DayOfWeek.SATURDAY}
        ));
        ...
        System.out.println(airport.getAirlinesForDayAndTime(DayOfWeek.FRIDAY, new Time(13,0,0)));
