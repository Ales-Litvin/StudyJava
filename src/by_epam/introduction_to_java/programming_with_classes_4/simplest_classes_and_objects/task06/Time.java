 ...
 *    Предусмотрите возможности установки времени и измения его отдельны полей (час, минута, секунда) с проверкой
 *        допустимсти вводимых значений. В случае недопустимых значений полей поле устанавливается в занчение 0.
