...
/*
 * Условие задачи:
 * 5. Опишите класс, реализующий десятичный счетчик, который может увеличивать или уменьшать совое занчение
 *        на удиницу в заданном диапазоне. Предусмотрите нинициализацию счетчика занчениями по умолчанию
 *        и произвольными значениями. Счетчик имеет методы увеличения и уменьшения состояния, и метод позволяющий
